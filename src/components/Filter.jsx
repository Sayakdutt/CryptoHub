  ...
  return (
    <div className="w-full lg:h-12 h-full lg:border-2 rounded-lg border-solid lg:border-gray-100 border-0 flex lg:flex-row flex-col lg:items-center lg:justify-between relative align-start justify-between ">
      ...
      <div className="flex lg:mr-7 justify-between mt-4 lg:mt-0 sm:flex-row flex-col relative">
        <form className="relative flex items-center font-nunito md:mr-12 mr-1"
        ...
        >
          ...
          <button type="submit" className="ml-1 cursor-pointer">
            <img src={submitIcon} alt="submit" className="text-cyan w-full h-auto"/>
          </button>
        </form>
        <label className="relative flex sm:justify-center justify-start item-center mt-4 sm:mt-0">
          <span className="sm:font-bold mr-2 font-medium sm:text-base text-sm w-16">sort by:</span>
          <select
            name="sortby"
          ...
          <img src={selectIcon} alt="select icon" className="w-[1rem] absolute right-1 top-2 pointer-events-none"/>
        </label>
        <button
