  ...
  return (
    ...
    >
      <svg
        ...
        ${allCoins.includes(data.id) ? "fill-cyan" : "fill-gray-100"} hover:fill-cyan`}
        width="30"
        height="30"
        viewBox="0 0 30 30"
        fill="cyan"
...
const Table = () => {
  const { crypto, currency } = useContext(CryptoContext);
  console.log(crypto);
  return (
    <>
      <div className="flex flex-col mt-9 border border-gray-100 rounded">
        {crypto ? (
          <table className="w-full table-auto">
            <thead className="capitilize text-base text-gray-100 font-medium border-b border-gray-100">
              <tr>
            ...
            hover:bg-gray-200 last:border-0"
                >
